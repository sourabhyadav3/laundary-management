...
const MakeInvoice = () => {
  const { customers, orders, addOrder, setCustomers, catalog, selectedBranch, payments, setPayments, services } = useContext(AdminStateContext);
              ...
              {catalog.map((g, idx) => {
                ...
                return (
                  <button
                    ...
                    className={`relative w-full flex flex-col items-center justify-between p-2.5 border rounded-2xl transition-all duration-200 hover:scale-105 active:scale-95 shadow-sm hover:shadow-md ${styleCard}`}
                  >
                    {/* Color dot indicator */}
                    <span
