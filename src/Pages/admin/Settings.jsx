            ...
            <div className="rounded-2xl border border-border bg-surface-alt p-6 space-y-4">
              ...
              {paymentForm.upiQrCode ? (
                <div className="flex flex-col items-center gap-4">
                  <img
                    src={paymentForm.upiQrCode}
                    alt="UPI QR Code"
                    className="h-48 w-48 rounded-2xl border-2 border-violet-400/40 object-contain shadow-lg"
                  />
                  <div className="flex gap-3">
                    ...
                    <button type="button" onClick={handleRemoveUpiQr} className="rounded-xl bg-rose-500/10 px-4 py-2 text-sm font-semibold text-rose-600 hover:bg-rose-500/20 transition">
                      Remove
                    </button>
                  </div>
                </div>
